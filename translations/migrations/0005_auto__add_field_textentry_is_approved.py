...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextEntry.is_approved'
        db.add_column(u'translations_textentry', 'is_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextEntry.is_approved'
        db.delete_column(u'translations_textentry', 'is_approved')
