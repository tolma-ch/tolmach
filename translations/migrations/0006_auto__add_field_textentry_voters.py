...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextEntry.voters'
        db.add_column(u'translations_textentry', 'voters',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextEntry.voters'
        db.delete_column(u'translations_textentry', 'voters')
