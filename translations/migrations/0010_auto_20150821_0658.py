    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_lang', models.ForeignKey(related_name='translations_target_lang', to='entries.Language')),
                ('text', models.ForeignKey(related_name='text_translations', to='translations.Text')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='translation',
            field=models.ForeignKey(related_name='translation_entries', default=None, to='translations.TextTranslation', null=True),
        ),
