...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'translations_textentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('body', self.gf('django.db.models.fields.TextField')(default='')),
            ('parent_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['translations.TextEntry'])),
        ...
        db.send_create_signal(u'translations', ['TextEntry'])


    def backwards(self, orm):
        # Deleting model 'TextEntry'
        db.delete_table(u'translations_textentry')
    ...
    models = {
        ...
        u'translations.textentry': {
            ...
            'parent_entry': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['translations.TextEntry']"}),
