...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextEntry.time_created'
        db.add_column(u'translations_textentry', 'time_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 16, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TextEntry.last_modified'
        db.add_column(u'translations_textentry', 'last_modified',
        ...
        db.add_column(u'translations_project', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 11, 16, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextEntry.time_created'
        db.delete_column(u'translations_textentry', 'time_created')

        # Deleting field 'TextEntry.last_modified'
        db.delete_column(u'translations_textentry', 'last_modified')

        # Deleting field 'Project.last_modified'
        db.delete_column(u'translations_project', 'last_modified')
