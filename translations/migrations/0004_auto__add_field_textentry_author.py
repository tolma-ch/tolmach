...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextEntry.author'
        db.add_column(u'translations_textentry', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextEntry.author'
        db.delete_column(u'translations_textentry', 'author_id')
