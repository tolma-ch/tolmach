...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tolmach_messages', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('originator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sender', to=orm['auth.User'])),
            ('addressee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='target', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'tolmach', ['Messages'])


    def backwards(self, orm):
        # Deleting model 'Messages'
        db.delete_table(u'tolmach_messages')
    ...
    models = {
        ...
        u'tolmach.usermeta': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'projects_particip': ('django.db.models.fields.TextField', [], {'default': "''"}),
